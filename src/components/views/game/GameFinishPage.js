    ...
    useEffect(() => {
        ...
        const saveUserGameHistory = async () => {
            const response = await api.post(
                `/users/${localStorage.getItem(
                    "userId"
                )}/gameHistories/${localStorage.getItem("gameId")}`
            );
        ...
        const fetchData = async () => {
            try {
                ...
                const isSurvivalMode = localStorage.getItem("survival");
                if (isSurvivalMode === "true") {
                    ...
                    const userResponse = await api.get(`/games/${localStorage.getItem(
                        "gameId")}/players`);
